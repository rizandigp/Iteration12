...
//	Helper functions
ID3D11InputLayout* D3D11GeometryChunk::CreateInputLayoutFromBufferLayouts( ID3D11Device* pDevice, BufferLayout* BufferLayouts[], int numberOfBuffers, const void *pShaderBytecodeWithInputSignature, SIZE_T BytecodeLength )
{
...
HRESULT D3D11GeometryChunk::CreateInputLayoutDescFromVertexShaderSignature( ID3DBlob* pShaderBlob, ID3D11Device* pD3DDevice, ID3D11InputLayout** pInputLayout )
{
	// Reflect shader info
