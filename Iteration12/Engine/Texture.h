...
enum TEXTURE_CLEAR_FLAG
{
	TEXTURE_CLEAR_COLOR = 0x1L,
	TEXTURE_CLEAR_DEPTH	= 0x2L,
	TEXTURE_CLEAR_STENCIL	= 0x4L,
	TEXTURE_CLEAR_ALL = ( ( TEXTURE_CLEAR_COLOR | TEXTURE_CLEAR_DEPTH ) | TEXTURE_CLEAR_STENCIL ),
};
